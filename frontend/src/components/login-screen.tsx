...
export function LoginScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-parchment-50 via-parchment-100 to-parchment-200 px-4">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-md">
        ...
        <div className="text-moss-400 mb-6" aria-hidden="true">
          <Music className="w-8 h-8" strokeWidth={1.5} />
        </div>

        {/* Title */}
        <h1 className="font-display text-5xl sm:text-6xl font-bold text-stone-900 tracking-tight">
          Tunebook
        </h1>

        {/* Thin decorative rule */}
        <div className="w-16 h-px bg-moss-400 mt-4 mb-6" aria-hidden="true" />
        ...
        {/* Subtle footer */}
        <p className="mt-12 text-sm text-stone-400 font-body">
